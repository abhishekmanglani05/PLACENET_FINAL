...
# yaha se ----- this is done to ensure security so that once the user is logged in and has put the password while logging in then it's password is not remembered while we press the back button.
@app.after_request
